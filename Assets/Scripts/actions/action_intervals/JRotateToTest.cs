...
{
    public class JRotateToTest : JFiniteTimeAction
    {
        ...
        public JRotateToTest(float duration, Vector3 toAngle) : base(duration)
        {
            Duration = duration;
            TargetAngle = toAngle;
        }
        ...
        {
            return new JRotateToStateTest(this, target);
        }
    ...
    public class JRotateToStateTest : JFiniteTimeActionState
    {


        public JRotateToStateTest(JRotateToTest action, GameObject target)
            : base(action, target)
        {
            if (Target == null)
            {
