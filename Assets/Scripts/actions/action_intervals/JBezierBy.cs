...
{
    public class JBezierBy : JFiniteTimeAction
    {
        public JBezierConfig BezierConfig { get; private set; }


        #region Constructors

        public JBezierBy (float t, JBezierConfig config) : base (t)
        {
            BezierConfig = config;
        }
        ...
        {
            return new JBezierByState (this, target);
    ...
    public class JBezierByState : JFiniteTimeActionState
    {
        protected JBezierConfig BezierConfig { get; set; }
        ...
        public override void Update (float time)
        {
            if (Target != null)
            {
                ...
                float x = JSplineMath.CubicBezier (xa, xb, xc, xd, time);
                float y = JSplineMath.CubicBezier (ya, yb, yc, yd, time);
                float z = JSplineMath.CubicBezier (za, zb, zc, zd, time);
