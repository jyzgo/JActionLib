...
namespace JUnity.Actions
{
    ...
    public abstract class JAction
    {
        ...
        protected JAction()
        {
            Tag = (int)JActionTag.Invalid;
        }

        #endregion Constructor


        protected internal virtual JActionState StartAction (GameObject target)
        {
            return null;
    ...
    public abstract class JActionState
    {
        /// <summary>
        ...
        public JAction Action { get; protected set; }
